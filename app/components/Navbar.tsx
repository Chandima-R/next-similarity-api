...
const Navbar = async ({}) => {
    ...
    return(
        ...
        >
            <div
                className="container max-w-7xl mx-auto w-full flex justify-between items-center"
            >
                ...
                <div className="hidden md:flex gap-4">
                    <ThemeToggle />
                    <Link href="/about" className={buttonVariants({variant:'ghost'})}>Documentation</Link>
